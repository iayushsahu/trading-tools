let checklistState = JSON.parse(
        localStorage.getItem("nq_checklistState")
      ) || {
      ...
      function updateChecklist() {
        ...
        localStorage.setItem("nq_checklistState", JSON.stringify(checklistState));
        updatePieChart();
      }
      ...
      function resetChecklist() {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            checklistState = { checks: [false, false, false, false, false, false, false, false, false, false] };
            localStorage.setItem("nq_checklistState", JSON.stringify(checklistState));
